...
<script type="text/javascript">
    import {province, city, area} from '../../common/city-data.js';
    export default {
        data: function(){
            return {
                target: '',
...
<template>
    <div class="ProvCityBoxWarp">
        <transition name="fade">
            <div class="ProvCityBoxBg" style="background: none;" v-show="show" @click="submit(false)" @touchmove="_stopDef"  @mousewheel="_stopDef"></div>
        </transition>
        <transition name="expand-select">
            <div class="ProvCityBox" v-show="show" @mousewheel="_stopDef">
                <div class="ProvCityHeader">
                    <div class="ProvCityHeaderCancle" @click="submit(false)">{{cancel}}</div>
                    {{title}}
